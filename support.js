...
(() => {
  ...
  // src/cdn.ts
  // Vendored locally (byte-identical, SRI-verified against the unpkg originals)
  // so the app can boot with zero network access instead of depending on a
  // third-party CDN being reachable for React itself.
