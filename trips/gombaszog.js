...
{id:'CS', letter:'CS', title:'Gombaszög', full:'Gombaszög — barlang a kerítésen kívül', kicker:'Csütörtök · a bázisnap', sub:'Nagy füves rét a Szlovák-karszt kapujában, patakkal · 1–2+ éj', transit:'Bátor → Eger → Gombaszög ≈ 2 óra · érkezés szerda este · innen minden 20–45 percen belül',
 ...
 {id:'cs3', n:'Kempingnap: patak, függőhíd, lovak', q:'Gombaszög kemping Slavec', b:'fo', age:'MINDEN KOR', meta:'fél nap · nulla kilométer · nulla forint',
 ...
 {id:'cs2', n:'Silická ľadnica — a jégbarlang torka', q:'Silická ľadnica', b:'megeri', age:'MINDEN KOR · hordozós terep', meta:'15 perc erdei séta · babakocsi nem',
...
{id:'FIX', letter:'FIX', title:'Gömör-délelőtt', full:'Kastélypark, márvány és egy torony', kicker:'Fix nap · amit érdemes előre lefixálni', sub:'Betlér, mauzóleum, Rozsnyó · az egyetlen nap, ami esőben is működik', transit:'Gombaszög → Betlér ≈ 25 perc · Rozsnyón át · 14:00-ra vissza a bázisra',
 pois:[
 {id:'fx1', n:'Betléri Andrássy-kastély', q:'Kaštieľ Betliar', b:'fo', age:'park: MINDEN KOR · kastély: SZÜLŐPROGRAM', meta:'2–3 óra · naponta 9:30–17:30', mon:true,
 ...
 {id:'fx2', n:'Andrássy-mauzóleum, Krasznahorkaváralja', q:'Mauzóleum Andrássy Krásnohorské Podhradie', b:'megeri', age:'SZÜLŐPROGRAM · váltásban', meta:'20–30 perc · sze–vas 8:30–16:00', mon:true,
 ...
 {id:'fx4', n:'Rozsnyó — Rákóczi-őrtorony és a főtér', q:'Rožňava Námestie baníkov', b:'opc', age:'6+ · SZÜLŐPROGRAM', meta:'144 lépcső · fél–1 óra',
 ...
 {id:'fx3', wk:'hu:Krasznahorka_vára', n:'Krásna Hôrka — Krasznahorka vára', q:'Hrad Krásna Hôrka', b:'opc', age:'FOTÓMEGÁLLÓ', meta:'2 perc · belülre nem lehet bemenni',
...
{id:'B', letter:'B', title:'Szádelő és kelet', full:'Szádelő és a kelet: nulla erőfeszítés, maximum látvány', kicker:'Elágazás B · a szurdok iránya', sub:'Sík murvás út 300 méteres falak között · kemping saját patakkal és pisztrángtóval', transit:'Gombaszög → Szádelő ≈ 35 perc · → Hammer Lake Camp ≈ +20 perc · útközben Hrhov',
 pois:[
 {id:'b1', n:'Szádelői-völgy · Zádielska tiesňava', q:'Zádielska tiesňava', b:'fo', age:'MINDEN KOR · babakocsi OK', meta:'sík murvás út · oda annyit, amennyit akartok',
 ...
 {id:'b2', n:'Háj-vízesések', q:'Hájske vodopády', b:'megeri', age:'3+', meta:'4 vízesés · rövid erdei séták · grillhelyek',
 ...
 {id:'b3', n:'Tornai vár · Turniansky hrad', q:'Turniansky hrad', b:'megeri', age:'3+', meta:'1,4 km · 20–30 perc fel · ingyen',
 ...
 {id:'b0', wk:'sk:Hrhov', n:'Hrhovi vízesés — útközbeni megálló', q:'Vodopád Hrhov', b:'megeri', age:'MINDEN KOR', meta:'5 perc séta a kocsitól · ingyen',
 ...
 {id:'b4', wk:'sk:Medzev', n:'Šugov-völgy, Medzev', q:'Šugovská dolina Medzev', b:'opc', age:'MINDEN KOR', meta:'10 perc a Hammer Lake Camptől',
 ...
 {id:'b5', wk:'sk:Jasovská_jaskyňa', n:'Jászói barlang · Jasovská jaskyňa', q:'Jasovská jaskyňa', b:'opc', age:'3+', meta:'1 óra · a premontrei kolostor szomszédja', mon:true, cash:true,
...
{id:'A', letter:'A', title:'Aggtelek — Jósvafő', full:'Aggtelek — Jósvafő: a Baradla és egy tavacska', kicker:'Elágazás A · a magyar oldal', sub:'Forint-zóna, SZÉP-kártya, magyar vezetés · ismerős terep', transit:'Gombaszög → Aggtelek ≈ 20 perc · határ: schengen, átgurulsz · 14:00-ra vissza a bázisra',
 pois:[
 {id:'a1', n:'Baradla — jósvafői rövidtúra', q:'Baradla-barlang jósvafői bejárat', b:'fo', age:'MINDEN KOR', meta:'1 óra · nyáron 11:00 és 15:00',
 ...
 {id:'a2', n:'Baradla — aggteleki rövidtúra', q:'Baradla-barlang Aggtelek', b:'fo', age:'MINDEN KOR', meta:'~1 óra · nyáron 10:00-tól több indulás',
 ...
 {id:'a4', wk:'hu:Jósvafő', n:'Tengerszem-tó és játszótér, Jósvafő', q:'Tengerszem-tó Jósvafő', b:'megeri', age:'MINDEN KOR · babakocsival', meta:'ingyen · fél délután',
 ...
 {id:'a5', wk:'hu:Hucul', n:'Hucul ménes tanösvény, Jósvafő', q:'Hucul ménes Jósvafő', b:'megeri', age:'MINDEN KOR · a kicsinek hordozó', meta:'4,5 km-es kör · gyalog az igazi',
 ...
 {id:'a3', wk:'hu:Baradla-barlang', n:'Vörös-tói középtúra', q:'Vörös-tói barlangbejárat Aggtelek', b:'opc', age:'3+ · nálunk már bevált', meta:'2,3 km · 100 perc · ~600 lépcső',
 ...
 {id:'a6', wk:'sk:Domica', n:'Domica-barlang, szlovák oldal', q:'Jaskyňa Domica', b:'opc', age:'MINDEN KOR', meta:'a Baradla szlovák fele', mon:true, cash:true,
...
{id:'C', letter:'C', title:'Romok és kaland', full:'Romok és kaland — félúton A és B között', kicker:'Elágazás C · a plusz nap', sub:'Nem költözöl: kirándulás bármelyik bázisról', transit:'Szögliget mindkét bázistól ≈ 25–40 perc · délutánra vissza',
 pois:[
 {id:'c1', n:'Szádvár', q:'Szádvár Szögliget', b:'fo', age:'3+ · a kicsinek háti hordozó', meta:'~30 perc meredek fel · tanösvény · ingyen',
 ...
 {id:'c2', wk:'hu:Derenk', n:'Derenk — a szellemfalu', q:'Derenk', b:'megeri', age:'MINDEN KOR · babakocsival döcöghető', meta:'~3 km sík erdei földút · ingyen',
 ...
 {id:'c5', n:'Buzgó-forrás tanösvény — a párhuzamos program', q:'Buzgó Krásnohorská Dlhá Lúka', b:'megeri', age:'MINDEN KOR', meta:'rövid tanösvény · ingyen',
 ...
 {id:'c3', n:'Krásnohorská kalandbarlang', q:'Krásnohorská jaskyňa', b:'opc', age:'OSZTOTT PROGRAM · 6+', meta:'2,5–3 óra · csak foglalással', cash:true,
 ...
 {id:'c4', n:'Ochtinai aragonitbarlang', q:'Ochtinská aragonitová jaskyňa', b:'opc', age:'3+', meta:'45 perc · 104 lépcső', mon:true, cash:true,
...
{id:'H', letter:'↩', title:'Hazaút', full:'Hazafelé: egy utolsó megálló', kicker:'Hazaút-modul', sub:'Rudabánya és az utolsó rövid kitérők', transit:'A-ból: Aggtelek → Eger ≈ 2 óra · B-ből: +45 perc · kitérő: Rudabánya',
 pois:[
 {id:'h1', n:'Rudapithecus Látogatóközpont és bányató', q:'Rudapithecus Látogatóközpont Rudabánya', b:'opc', age:'MINDEN KOR', meta:'kedd–szombat 8–16 · Rudabánya', mon:true,
...
plans:[
{id:'d1', n:'Délután a Gombaszögi kempingben', b:'megeri', age:'MINDEN KOR', meta:'a bázis · patakos', q:'Gombaszög kemping Slavec',
...
{id:'d2', n:'Délután a Hammer Lake Campben', b:'megeri', age:'MINDEN KOR', meta:'a csendes · vizes', q:'Hammer Lake Camp Nižný Medzev',
...
{id:'d3', n:'Délután a Baradla kempingben', b:'opc', age:'MINDEN KOR', meta:'a barlangkapu · szárazabb', q:'Baradla Kemping Aggtelek',
