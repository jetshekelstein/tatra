...
{id:'A', letter:'A', title:'Zemplén', full:'Zemplén — várak vulkáni kúpokon és egy óriási híd', kicker:'Modul A · Magyar oldal', sub:'Vulkáni dombok, hegytetői romok, termálvíz · 1–2 nap', transit:'Eger → Boldogkő ≈ 1 óra · a végén 5 percre a szlovák határtól',
 pois:[
 {id:'a3', ll:[48.4,21.64], n:'Zemplén Kalandpark, Sátoraljaújhely', q:'Zemplén Kalandpark Sátoraljaújhely', b:'fo', age:'MINDEN KOR', meta:'kalandpark · egész nap',
 ...
 {id:'a1', ll:[48.343,21.236], n:'Boldogkő vára', q:'Boldogkői vár', b:'megeri', age:'4+', meta:'várrom · 1½–2 óra',
 ...
 {id:'a2', ll:[48.317,21.572], n:'Sárospatak — Rákóczi-vár + tengerszem', q:'Rákóczi-vár Sárospatak', b:'megeri', age:'vár 4+ · tengerszem: mind', meta:'vár + fürdés · fél nap', mon:true,
 ...
 {id:'a4', ll:[48.545,21.458], wk:'hu:Füzéri_vár', n:'Füzér és Regéc vára', q:'Füzér vára', b:'opc', age:'Füzér 6+ · Regéc 4+', meta:'2–3 óra darabja',
...
{id:'B', letter:'B', title:'Kassa · Košice', full:'Kassa — gőzös, gejzír, nagyvárosi finomságok', kicker:'Modul B · Szlovákia második városa', sub:'Košice és a játszóhegyei · könnyű 1–2 nap', transit:'Sátoraljaújhely → Kassa ≈ 45 perc · gejzír-kitérő +30 perc keletre',
 ...
 pois:[
 {id:'b4', ll:[48.759,21.216], n:'Gyermekvasút, Csermely-völgy (Čermeľ)', q:'Detská železnica Košice Čermeľ', b:'fo', age:'MINDEN KOR', meta:'gőzvasút · 2–3 óra piknikkel',
 ...
 {id:'b5', ll:[48.801,21.478], n:'Ránkfüredi gejzír (Herľany)', q:'Herliansky gejzír Herľany', b:'fo', age:'4+', meta:'28 km keletre · 25 perc műsor',
 ...
 {id:'b6', ll:[48.78,21.216], n:'Kassai állatkert + Dinopark, Kavečany', q:'ZOO Košice Kavečany', b:'megeri', age:'MINDEN KOR', meta:'3–4 óra',
 ...
 {id:'b7', ll:[48.72,21.258], wk:'hu:Kassai_Szent_Erzsébet-főszékesegyház', n:'Esti óváros', q:'Dóm svätej Alžbety Košice', b:'megeri', age:'MINDEN KOR', meta:'ingyen · 1–2 óra',
...
{id:'C', letter:'C', title:'Gömör', full:'Gömör — az alvilág: jég, aragonit, kastély', kicker:'Modul C · A hazaút folyosója', sub:'Barlangvidék · válassz 2-t a 3 nagy megállóból', transit:'Poprád → jégbarlang ≈ 1 óra · → Betlér ≈ 45 perc · → Szádelő ≈ 30 perc · → Aggtelek ≈ 45 perc · → Eger ≈ 2 óra',
 pois:[
 {id:'c1', ll:[48.871,20.3], n:'Dobsinai-jégbarlang (UNESCO)', q:'Dobšinská ľadová jaskyňa', b:'fo', age:'4+', meta:'~2,5 óra a sétával', mon:true, cash:true,
 ...
 {id:'c2', ll:[48.708,20.512], n:'Betlér (Betliar) — Andrássy-kastély', q:'Kaštieľ Betliar', b:'fo', age:'park: mind · kastély: szülő', meta:'2–3 óra', mon:true,
 ...
 {id:'c3', ll:[48.658,20.601], wk:'hu:Krasznahorka_vára', n:'Krasznahorka + Andrássy-mauzóleum', q:'Hrad Krásna Hôrka', b:'opc', age:'SZÜLŐPROGRAM', meta:'30 perc',
 ...
 {id:'c4', ll:[48.664,20.31], wk:'sk:Ochtinská_aragonitová_jaskyňa', n:'Martonházai-aragonitbarlang · Imrikfalvi-tó', q:'Ochtinská aragonitová jaskyňa', b:'opc', age:'4+ / tó: MINDEN KOR', meta:'barlang ~1 óra · tó: lusta délután', mon:true,
...
{id:'CP', letter:'C+', title:'Szlovák Paradicsom', full:'Szlovák Paradicsom — a létrák országa', kicker:'Modul C+ · Szurdokok és létrák', sub:'A Tátra és Kassa között félúton · saját kemping, saját napok', transit:'Poprád → Podlesok ≈ 40 perc · jégbarlang → Imrikfalva ≈ 20 perc · Podlesok → Kassa ≈ 1 óra 15',
 ...
 pois:[
 {id:'cp1', ll:[48.953,20.388], n:'Hornád-áttörés (Prielom Hornádu)', q:'Prielom Hornádu', b:'fo', age:'6+', meta:'végig 4–5 óra · 11 km · félútig 3 óra',
 ...
 {id:'cp2', ll:[48.951,20.381], n:'Suchá Belá-szurdok, Podlesok', q:'Suchá Belá roklina', b:'fo', age:'8+', meta:'4–4½ óra kör',
 ...
 {id:'cp3', ll:[48.872,20.343], n:'Hnileci-völgy: Imrikfalva → Stratená', q:'Stratenský kaňon', b:'megeri', age:'MINDEN KOR', meta:'sík völgy · 10 km oda-vissza · gyalog 3 óra, bringával 1½',
 ...
 {id:'cp4', ll:[48.865,20.374], n:'Imrikfalvi-tó (Palcmanská Maša), Dedinky', q:'Palcmanská Maša Dedinky', b:'megeri', age:'MINDEN KOR', meta:'fürdés, csónak · lusta délután',
 ...
 {id:'cp5', ll:[48.874,20.394], wk:'sk:Zejmarská_roklina', n:'Zejmarská-szurdok + Geravy', q:'Zejmarská roklina', b:'opc', age:'6+', meta:'2,5–3 óra kör',
 ...
 {id:'cp6', ll:[48.938,20.437], wk:'sk:Tomášovský_výhľad', n:'Tomášovský-kilátó, Čingov', q:'Tomášovský výhľad', b:'opc', age:'4+', meta:'2 óra oda-vissza · létrák nélkül',
...
{id:'D', letter:'D', title:'Szepesség · Spiš', full:'Szepesség — a várhorizont', kicker:'Modul D · Keleti folyosó', sub:'A „Kassa és a Dunajec közti" étlapod', transit:'Kassa → Szepesi vár ≈ 1 óra · → Ólubló ≈ 45 perc · → Dunajec ≈ 30 perc',
 pois:[
 {id:'d1', ll:[48.999,20.768], n:'Szepesi vár (Spišský hrad, UNESCO)', q:'Spišský hrad', b:'fo', age:'4+', meta:'mega-rom · 2–3 óra',
 ...
 {id:'d3', ll:[49.317,20.697], n:'Lublói vár + skanzen (Ólubló)', q:'Ľubovniansky hrad', b:'fo', age:'MINDEN KOR', meta:'fél nap · solymászat, lovagi bemutató',
 ...
 {id:'d4', ll:[49.305,20.632], n:'Nestville Park, Hniezdne', q:'Nestville Park Hniezdne', b:'megeri', age:'MINDEN KOR', meta:'tanya + csokiműhely · 2–3 óra',
 ...
 {id:'d2', ll:[49.026,20.589], wk:'hu:Lőcse', n:'Lőcse (Levoča, UNESCO)', q:'Levoča', b:'opc', age:'SZÜLŐPROGRAM', meta:'1–2 óra · főtér + fagyi',
 ...
 {id:'d5', ll:[49.303,20.567], wk:'sk:Vyšné_Ružbachy', n:'Felsőzúgó fürdő (Vyšné Ružbachy) · Késmárk', q:'Vyšné Ružbachy kúpele', b:'opc', age:'MINDEN KOR', meta:'fürdő 2–3 óra · Késmárk 1–2 óra',
...
{id:'E', letter:'E', title:'Pieniny · Dunajec', full:'Pieniny és a Dunajec — tutajok, szurdok, gorál vidék', kicker:'Modul E · A lengyel határfolyó', sub:'Az út legmesésebb napja — a lengyel parttal együtt', transit:'Ólubló → Vöröskolostor ≈ 30 perc · Nedec ≈ 15 perc a határon át · Tátralomnic ≈ 1 óra a Magurán át',
 pois:[
 {id:'e4', ll:[49.395,20.417], n:'Dunajec-tutajozás, Vöröskolostor → Lesnica', q:'Pltisko Červený Kláštor', b:'fo', age:'MINDEN KOR · bringa: 6+', meta:'1½–2 óra sodrás + ~45 perc bringa', cash:true,
 ...
 {id:'e5', ll:[49.413,20.313], n:'Nedec vára + Czorsztyn + tavi hajók (PL)', q:'Zamek Niedzica', b:'megeri', age:'4+', meta:'fél nap · złoty vagy kártya',
 ...
 {id:'e6', ll:[49.389,20.105], wk:'pl:Białka_Tatrzańska', n:'Termy Bania, Białka Tatrzańska (PL)', q:'Termy Bania Białka Tatrzańska', b:'opc', age:'MINDEN KOR', meta:'élményfürdő · fél nap',
 ...
 {id:'e7', ll:[49.427,20.483], wk:'pl:Szczawnica', n:'Szczawnica · monostor · Három Korona', q:'Szczawnica', b:'opc', age:'4+ / gerinc: 8+', meta:'három kitérő a tutajnap köré',
...
{id:'F', letter:'F', title:'Magas-Tátra', full:'Magas-Tátra — lent parkolsz, fent utazol', kicker:'Modul F · Bázistábor, 3–5 éjszaka', sub:'Tátralomnic bázis · a busz áll, a vasutak másznak', transit:'Vöröskolostor → Tátralomnic ≈ 1 óra · Poprád ≈ 15 perc · minden más TEŽ-zsel és felvonóval',
 pois:[
 {id:'f1', ll:[49.189,20.234], n:'Kő-pataki-tó (Skalnaté pleso) — a nagy menet', q:'Lanovka Tatranská Lomnica Skalnaté pleso', b:'fo', age:'MINDEN KOR', meta:'kabinos felvonó · fél nap',
 ...
 {id:'f2', ll:[49.153,20.22], n:'Tarajka-sikló (Hrebienok) + Tarpatak vízesései', q:'Hrebienok Starý Smokovec', b:'megeri', age:'MINDEN KOR', meta:'3–4 óra a kempingtől',
 ...
 {id:'f3', ll:[49.12,20.058], n:'Csorba-tó (Štrbské pleso) fogaskerekűvel', q:'Štrbské pleso', b:'megeri', age:'MINDEN KOR', meta:'tavi nap · fél nap',
 ...
 {id:'f4', ll:[49.23,20.318], wk:'sk:Belianska_jaskyňa', n:'Bélai-barlang (Belianska jaskyňa)', q:'Belianska jaskyňa', b:'opc', age:'6+', meta:'10 perc a bázistól · ~1½ óra', mon:true,
  ...
  w:'HÉTFŐN ZÁRVA.'},
 {id:'f5', ll:[49.066,20.293], wk:'sk:Poprad', n:'Termál: AquaCity Poprád · Ménhárd · Tricklandia', q:'AquaCity Poprad', b:'opc', age:'MINDEN KOR', meta:'esős napra · 2–4 óra',
...
hikes:[
{id:'h1', ll:[49.12,20.058], wk:'sk:Štrbské_pleso', n:'1 · Csorba-tavi körséta', go:'TEŽ ~1 óra, a tónál szállsz le', time:'45 perc · 2,5 km · kör', elev:'sík', diff:'konnyu', kid:'MINDEN KOR · babakocsi OK', q:'Štrbské pleso'},
{id:'h2', ll:[49.159,20.238], wk:'sk:Vodopády_Studeného_potoka', n:'2 · Tarpataki vízesések + Rainer-kunyhó', go:'TEŽ Ótátrafüredig + sikló a Tarajkára', time:'1,5–2 óra · 4 km · oda-vissza', elev:'±120 m', diff:'konnyu', kid:'MINDEN KOR · babakocsi az első vízesésig', q:'Vodopády Studeného potoka'},
{id:'h3', ll:[49.189,20.234], wk:'sk:Skalnaté_pleso', n:'3 · Kő-pataki-tó katlanséta', go:'kabinos felvonó a faluból', time:'szabadon · ~1 km · a lift hoz vissza', elev:'a lift viszi', diff:'konnyu', kid:'MINDEN KOR (hordozós terep)', q:'Skalnaté pleso'},
{id:'h4', ll:[49.269,20.313], wk:'sk:Bachledova_dolina', n:'4 · Bachledka lombkorona-sétány', go:'25 perc autóval a Magurán át', time:'1–1,5 óra · 1,2 km · kör', elev:'enyhe rámpa', diff:'konnyu', kid:'MINDEN KOR · babakocsi OK', q:'Bachledka Ski & Sun'},
{id:'h5', ll:[49.154,20.081], wk:'sk:Popradské_pleso', n:'5 · Poprádi-tó (Popradské pleso)', go:'TEŽ a Csorba-tóig, aszfaltos szervizút', time:'2,5–3 óra · 8 km · oda-vissza', elev:'+250 m', diff:'konnyu', kid:'4+ gyalog · babakocsival is megy', q:'Popradské pleso'},
{id:'h6', ll:[49.189,20.234], wk:'sk:Skalnaté_pleso', n:'6 · Kő-pataki-tó → Tátralomnic gyalog', go:'felvonóval fel, gyalog haza a Štarton át', time:'2–2,5 óra · 6 km · csak lefelé', elev:'−890 m', diff:'kozepes', kid:'6+ · térd kérdése, nem tüdőé', q:'Skalnaté pleso'},
{id:'h7', ll:[49.22,20.221], wk:'sk:Zelené_pleso', n:'7 · Zöld-tó (Zelené pleso)', go:'Biela Voda parkoló, 5 perc autó', time:'5–6 óra · 16 km · oda-vissza', elev:'+560 m', diff:'kozepes', kid:'7+ kitartással · menedékházi ebéd', q:'Chata pri Zelenom plese', cash:true},
{id:'h8', ll:[49.272,20.253], wk:'sk:Ždiar', n:'8 · Monkova-völgy köre, Ždiar', go:'20 perc autóval (Bélai-Tátra)', time:'4–5 óra · 9 km · kör', elev:'+700 m', diff:'kozepes', kid:'8+ · csak jún. 16.–okt. 31.', q:'Monkova dolina Ždiar'},
{id:'h9', ll:[49.192,20.201], wk:'sk:Téryho_chata', n:'9 · Téry-menedékház, Kis-Tarpatak-völgy', go:'sikló a Tarajkára, onnan fel a völgyön', time:'5–6 óra · 11 km · oda-vissza', elev:'+750 m', diff:'nehez', kid:'biztos lábú 9+ · köves szerpentinek', q:'Téryho chata'}],

plans:[
{id:'p1', ll:[49.17,20.222], n:'1. terv — A Nagy Átkelés: fel liften, haza gyalog', b:'fo', age:'6+', meta:'~4 óra gyalog, végig lefelé',
...
{id:'p2', ll:[49.12,20.058], n:'2. terv — „Olimpiai" tavi lazanap', b:'megeri', age:'MINDEN KOR', meta:'könnyű · babakocsi OK · fél nap',
...
{id:'p3', ll:[49.22,20.221], n:'3. terv — Zöld-tó: a nagy nap', b:'fo', age:'7+', meta:'közepes · 5–6 óra', cash:true,
...
{id:'p4', ll:[49.161,20.229], n:'4. terv — Vízesések és a pici kunyhó', b:'megeri', age:'MINDEN KOR', meta:'babakocsival is · 3–4 óra',
...
{id:'p5', ll:[49.203,20.23], n:'5. terv — Nagy-Morgás (Veľká Svišťovka), a gerincnap', b:'megeri', age:'9+ · NEHÉZ', meta:'rövid változat 3–4 óra · teljes átkelés 7–8', cash:true,
